(() => {
  ...
  compactStyle.textContent = `
    ...
    .section-head{margin:11px 2px 5px!important}.section-head h3{font-size:17px!important}.section-head p{font-size:10px!important;margin:1px 0!important}.day{margin-bottom:6px!important}.datebar{margin:0 0 4px 5px!important;gap:5px!important}.datebar strong{font-size:13px!important}.datebar span{font-size:10px!important}
    .event{padding:8px 10px!important;border-radius:12px!important;gap:6px!important;margin-bottom:4px!important;min-height:64px!important;grid-template-columns:minmax(170px,1.6fr) repeat(3,minmax(62px,.55fr)) minmax(105px,.7fr)!important}
    .event:hover{transform:none!important;box-shadow:none!important}.event-title{gap:7px!important}.flag{width:27px!important;height:27px!important;border-radius:8px!important;font-size:12px!important}
    .event h4{font-size:14px!important;margin-bottom:0!important;line-height:1.2!important}.event-title p,.metric span{font-size:10px!important;line-height:1.1!important}.metric b{font-size:11px!important;margin-top:0!important}
    .impact{padding:2px 6px!important;font-size:8px!important}.signal{padding:6px 8px!important;border-radius:9px!important}.signal b{font-size:14px!important}.signal small{font-size:9px!important}
