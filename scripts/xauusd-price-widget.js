(() => {
  ...
  compactStyle.textContent = `
    ...
    .section-head{margin:11px 2px 5px!important}.section-head h3{font-size:17px!important}.section-head p{font-size:10px!important;margin:1px 0!important}.day{margin-bottom:6px!important}.datebar{margin:0 0 4px 5px!important;gap:5px!important}.datebar strong{font-size:14px!important}.datebar span{font-size:11px!important}
    .event{padding:8px 10px!important;border-radius:12px!important;gap:7px!important;margin-bottom:4px!important;min-height:66px!important;grid-template-columns:minmax(180px,1.6fr) repeat(3,minmax(68px,.55fr)) minmax(112px,.7fr)!important}
    ...
    .event h4{font-size:16px!important;margin-bottom:0!important;line-height:1.2!important}.event-title p,.metric span{font-size:11px!important;line-height:1.15!important}.metric b{font-size:13px!important;margin-top:0!important}
    .impact{padding:3px 7px!important;font-size:9px!important}.signal{padding:7px 9px!important;border-radius:9px!important}.signal b{font-size:15px!important}.signal small{font-size:10px!important}
    .expand{display:none!important}.meter{height:4px!important}.meter-row{gap:5px!important}.score{font-size:12px!important}.footer{margin-top:8px!important;padding:8px!important;font-size:10px!important}
